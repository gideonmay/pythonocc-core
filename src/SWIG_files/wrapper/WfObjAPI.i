...
class WfObjAPI {
	...
	:rtype: void
") Write;
		static void Write (const TopoDS_Shape & aShape,const char * aFile);
...
%nodefaultctor WfObjAPI_Reader;
class WfObjAPI_Reader {
	public:
		%feature("compactdefaultargs") WfObjAPI_Reader;
...
%nodefaultctor WfObjAPI_Writer;
class WfObjAPI_Writer {
	public:
		%feature("compactdefaultargs") WfObjAPI_Writer;
		%feature("autodoc", "	* Creates a writer object with default parameters: RelativeMode, SetCoefficent, SetDeflection. These parameters may be modified.
...
") SetCoefficient;
	...
	:rtype: None
") Write;
		void Write (const TopoDS_Shape & aShape,const char * aFileName,const Standard_Boolean theInParallel);
};
